...
<?php if(isset($_REQUEST['path']) && $_REQUEST['path']!=''){
	$path=$_REQUEST['path'];
}else{
...
<script>
var pdffile='<?php echo $path; ?>';

$.ajax({
                type: "POST",
                url: 'https://vmsbodddecls23.digimarker.online/answerSheet/viewSheet',
                async : false,
                data: { 
                    'path' : pdffile
                }
					...
					if(data.success==false){
						window.location.href="https://vmsbodddecls23.digimarker.online/answerSheet/viewClose";
					}
                });
//alert(pdffile);
</script>
        ...
        <div class="toolbar">
          <div id="toolbarContainer">
            ...
            <div id="customProgress" style="text-align:center;background:#FDFDFB;min-height:95vh">
              <img src="https://witjune2023.digimarker.online/logo/logo.png" /> 
            </div> 
          </div>
        </div>
