                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xl-3">
                                <div class="card-box">
                                    ...
                                    <div class="mt-3">
                                        <h6 class="text-uppercase"><?php echo sizeof($logged_in); ?> Active Marker out of <?=count($evaluators)?> <span class="float-right"><?php echo sizeof($logged_in); ?>%</span></h6>
                                        <div class="progress progress-sm m-0">
                            ...
                            <div class="col-md-3 col-xl-3">
                                <div class="card-box">
                                    ...
                                    <div class="mt-3">
                                        <h6 class="text-uppercase">Script checked out of <?php echo $sheets; ?> <span class="float-right"><?php if($checked !=0){ echo round($checked*100/$sheets);}else{ echo 0; } ?>%</span></h6>
                                        <div class="progress progress-sm m-0">
                                            <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="18" aria-valuemin="0" aria-valuemax="100" style="width: <?php if($checked !=0){ echo round($checked*100/$sheets);}else{ echo 0; }  ?>%">
