    ...
    <div class="page-content vertical-align-middle" style="width:400px;margin-top:50px">
      <div class="panel">
        <div class="panel-body">
		  ...
		  <h3 class="text-center">Add profile photo</h3>
...
<?php 
        ...
        ?>
				...
				<img id="capturedImage" style="display: none;width: 200px;height:200px;border-radius: 50%;margin-left: 39px;">
		
				  <button onclick="startAnalysis()" class="btn btn-primary btn-block btn-lg mt-40">Capture Photo</button>
          <button onclick="saveimage()" class="btn btn-primary btn-block btn-lg mt-40" style="display: none;" id="saveimage">Add profile photo</button>
				  <p >
				   <br><br>
 ...
 <!-- SHA256 -->
   ...
   <?php 
     ...
     $region= $face_detail['Face_Setting']['region'];
     $accesscode= $face_detail['Face_Setting']['accesscode'];
     $securekey= $face_detail['Face_Setting']['securekey'];
    ?>
	...
	<script type="text/javascript">
      ...
      const csrfName="<?php echo $this->security->get_csrf_token_name(); ?>";
	  	...
	  	const url_path="<?php echo base_url("Login/register_profile_pic"); ?>";
      const logout_path="<?php echo base_url("login/face_session_out/"); ?>";
      
  </script>
    <script src="<?php echo base_url(); ?>js/acc.js"></script>
    <script>
        function hashpass(){
