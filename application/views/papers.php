                                        ...
                                        foreach ($papers as $paper) {
                                          ...
                                          $subject_name = $subject_array[0]['subject_name'];
                                            ...
                                            if ($paper['marking_scheme_json']!='') {
                                                ...
                                                echo "</td>";?>
													<td><?php 
													$file=explode("/",$paper['paper_model_question']);
														  $folderPath = "answersheets/uploads/model/".$file[2]."img";
														   $countFile=$folderPath.'/count.txt';
															if (!file_exists($folderPath)) {
																...
																$countt=file_get_contents($countFile);
																
															}
													
													?>
													<a href="<?php echo base_url()."upload2/extractNewModel/".$file[2]; ?>" class='btn btn-info' target="_blank">Convert(<?php echo $countt; ?>)</a>
