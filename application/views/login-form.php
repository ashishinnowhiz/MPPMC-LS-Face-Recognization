  ...
  <nav class="site-navbar navbar navbar-default navbar-inverse navbar-fixed-top navbar-mega"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        <img class="navbar-brand-logo" src="<?php echo base_url(); ?>logo/logo.jpg" title="DigiMaker">
...
<?php if ($this->session->flashdata('success')) {
		  ...
		  <?php if ($this->session->flashdata('error')) {
                        echo "<div class='alert alert-danger' id='flash-msg'>".$this->session->flashdata('error')."</div>";
                    }
                        $csrf = array(
                                'name' => $this->security->get_csrf_token_name(),
                                'hash' => $this->security->get_csrf_hash()
           ...
           <!-- <?php if($role == "Marker"){?>
            ...
            <?php }else{?>
              ...
              <?php }?> -->
              <form role="form" name='loginForm' onsubmit="return hashpass();"  action='<?php echo base_url(); ?>login/check_user_name' method='POST'>
           <!--Code End Here-->
          ...
          <input type="hidden" name="cameraStatus" id="cameraStatus"  />
        ...
        $(document).ready(function () {
            ...
            navigator.mediaDevices.getUserMedia({ video: true })
                ...
                .catch(function (error) {
                    // Camera is not available or access is denied
                    $("#cameraStatus").val("0");
                });
        });
    </script> 
