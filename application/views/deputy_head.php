<?php defined('BASEPATH') or exit('No direct script access allowed'); ?>
		<div class="content">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Depty Head Markers</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Depty Head Markers</h4>
                                </div>
                            </div>
                        </div>    
            ...
            <?php if (sizeof($deputies)>0) { ?>
            <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Depty Head Markers List</h4>
