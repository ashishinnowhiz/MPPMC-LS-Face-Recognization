<style>
    ...
    .queNo,.pageNo,.toolLink{padding:6px;border:1px solid #727272;display:block;text-align:center;margin:2px;color:#727272;border-radius:50%;}
    .queNo{max-width:50px;}
    .pageNo{margin:2px auto;width:30px;}
    .clear{clear:both;}
    .toolLink{float:left;width:50px;line-height:30px;padding:10px;margin:5px 4px;border:0px;background-color:#bfcaf4;}
...
<div id='toolBar' style='position:fixed;width:100%;top:40px;left:0;height:40px;z-index:1004;background-color:#F1F1F1;'>
        ...
        <div style='float:right;background-color:#bbcaf4;text-align:center;padding:10px;font-weight:600;'>
            <a onclick="getHelp()" style='color:#4291a9;'><i class="fa fa-question-circle fa-fw"></i>Get Help</a>
        </div>
		<?php } ?>
		<div style='float:right;background-color:#c5c5c5;margin-right:40%;text-align:center;padding:10px;'>
        ...
        <a id='comment' data-toggle="tooltip" data-placement="top" title="Add Comment" class='toolLink' onclick="selectTool('comment')"><i class="fa fa-font fa-fw"></i></a>
...
<div class="modal fade" id="summaryHead" tabindex="-1" role="dialog" aria-labelledby="summaryModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="summaryModalLabel">Marker Mark Summary</h4>
      </div>
      <div class="modal-body" id='summaryBody' style='max-height:400px; overflow-y: scroll;'>
        <table id='summaryTableHead' class='table table-striped table-hover'>
...
<div class="modal fade" id="helpModal" tabindex="-1" role="dialog" aria-labelledby="helpModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="helpModalLabel">DigiMarker ChatBot</h4>
      </div>
      <div class="modal-body" id='summaryBody' style='height: 80vh;overflow: visible;'>
              <iframe src="https://toai.two8ai.com/embed/agent?agent_id=8f93ae15-b60e-4056-8d5f-346d06cf6dcc&token=tk_5ee544a5503fc1bb92fb78c1cdfa03dc69285feabb8a1c1a8915127ae351e4df" style="width:100%; height:100%; border:none; border-radius: 8px;"></iframe>
      </div>
...
<script src="<?php echo base_url(); ?>js/evalsample.js"></script>
</div>