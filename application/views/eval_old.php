...
<script src="<?php if($_SESSION[$this->config->item('exam')['exam_session']]['user_role']=='Head_Evaluator'){echo base_url()."js/eval_head.js";}elseif($_SESSION[$this->config->item('exam')['exam_session']]['user_role']=='Head_Marker'){echo base_url()."js/eval_marker.js";}else{echo base_url()."js/eval.js";} ?>"></script>
</div>