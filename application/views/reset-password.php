      ...
      <div class="panel">
        <div class="panel-body" style='margin-top: 40px;width: 400px;'>
		  ...
		  <?php if ($this->session->flashdata('error')) {
              ...
              <form role="form" name='loginForm' action='<?php echo base_url(); ?>ResetPassword/send_otp' method='POST'>

                  <div class="form-group form-material floating" data-plugin="formMaterial">
                    <input type="email" class="form-control" name="email"  autofocus required value='<?=$email?>' />
                    <label class="floating-label">Email</label>
                  </div>

                  <?php if(isset($otp)){?>
                    <div class="form-group form-material floating" data-plugin="formMaterial">
                    <input type="text" class="form-control" name="otp"   autofocus required />
