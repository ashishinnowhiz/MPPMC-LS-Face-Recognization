...
border-radius: 5px;">
    ...
    <div class="page-content vertical-align-middle">
      <div class="panel">
        <div class="panel-body" style='margin-top: 40px;width: 400px;'>
          <div class="brand">
		  ...
		  <?php if ($this->session->flashdata('error')) {
              ...
              <form role="form" name='loginForm' onsubmit="check_pass(event)" action='<?php echo base_url(); ?>ResetPassword/update_password' method='POST'>

                  <div class="form-group form-material floating" data-plugin="formMaterial">
                    <input type="text" class="form-control" name="password"  autofocus required id='pass'/>
                    <label class="floating-label">New Password</label>
                  </div>

                    <div class="form-group form-material floating" data-plugin="formMaterial">
                    <input type="password" class="form-control" id='c_pass'   autofocus required />
                    <label class="floating-label">Confirm Password</label>
                  </div>
                  <span class='text-danger' id='errMes'></span>
                  <button type="submit" value="Login" class="btn btn-primary btn-block btn-lg mt-40">Submit</button>
 ...
 <!-- SHA256 -->
    ...
    function check_pass(e){
        ...
        if(pass === c_pass){
          ...
          console.log("Passwords should not match.");
        } else {
          e.preventDefault();
          document.getElementById('errMes').innerText = 'Password and Confirm Password Should be Same';
