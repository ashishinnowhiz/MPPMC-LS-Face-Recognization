...
border-radius: 5px;">
    ...
    <div class="page-content vertical-align-middle" style="width:400px;margin-top:100px">
      <div class="panel">
        <div class="panel-body">
          <div class="brand">
            
            <h2 class="brand-text font-size-18 text-center">SELECT ROLE</h2>
          </div>
		  ...
		  <?php if (isset($error)) {
             ...
             <form role="form" name='loginForm' onsubmit="return hashpass();"  action='<?php echo base_url(); ?>login/loginForm' method='POST' >
         
                <select name="role" id="" class="form-control" required>
                    <option value="">--Select Role--</option>
                    <option value="Coordinator">Coordinator</option>
                    <option value="Marker">Head Marker</option>
                    <option value="Marker">Deputy Head Marker</option>
                    <option value="Marker">Marker</option>
                </select>

             <button type="submit" value="Login" class="btn btn-primary btn-block btn-lg mt-40">Select</button>
