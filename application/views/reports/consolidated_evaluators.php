                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Marker Consolidated Reports</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Marker Consolidated Reports</h4>
                                </div>
                            </div>
                        </div>
...
function onCklickBtn(){
	...
	// window.location=baseurl+"reports/dated_evaluators?date_from="+minDate+"&date_to="+maxDate+"&course="+course; //course field added by vikas on 17/04/23
    //Code Written By Vikas
    $role = "<?=$_SESSION[$this->config->item('exam')['exam_session']]['user_role']?>";
    if($role == "Head_Marker"){
        window.location=baseurl+"marker/dated_evaluators?date_from="+minDate+"&date_to="+maxDate;
