                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">HM Consolidated Reports</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">HM Consolidated Reports</h4>
                                </div>
                            </div>
                        </div>
								...
								<table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <!-- <th>Scripts Rechecked</th> -->
                                            <th>Checked Under HE</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
...
function onCklickBtn(){
	...
	window.location=baseurl+"reports/dated_heads?date_from="+minDate+"&date_to="+maxDate+"&course="+course; //course field added by vikas on 17/04/23;
