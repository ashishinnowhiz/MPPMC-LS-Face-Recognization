    ...
    <div class="container" style='background-color:#fff;min-height:800px;'>
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Head Marker Daily Report</h1>
            </div>
        </div>
        <br/><br/>
        <div class="row">
            <div class="col-lg-6">
                <table class="">
                   <tr><td><b>Name</b></td><td><?php echo $examiner['examiner_name']; ?></td></tr>
                   <tr><td><b>Email</b></td><td><?php echo $examiner['examiner_email']; ?></td></tr>
                   <tr><td><b>Mobile</b></td><td><?php echo $examiner['examiner_phone']; ?></td></tr>
                </table>
            </div>
            <div class="col-lg-6">
                <table class="">
...
<td>".$report['paper_code']."</td>													<td>".$report['evaluation_marks']."</td>
