                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Subject Wise HE Consolidated Reports</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Subject Wise HE Consolidated Reports</h4>
                                </div>
                            </div>
                        </div>
...
function onCklickBtn(){
	...
	window.location=baseurl+"subjects/dated_examiners?date_from="+minDate+"&date_to="+maxDate+"&course="+course; //course field added by vikas
