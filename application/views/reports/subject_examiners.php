                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Subject Wise HM Daily Reports</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Subject Wise HM Daily Reports</h4>
                                </div>
                            </div>
                        </div>
...
function onCklickBtn(){
	...
	window.location=baseurl+"subjects/examiners?date="+dateVal+"&course="+course;
...
function doOnLoad() {
    ...
    myCalendar.attachEvent("onClick", function(d){
        ...
        window.location=baseurl+"subjects/examiners/"+myCalendar.getFormatedDate(null,d);
    });
}
doOnLoad(); */
</script>
