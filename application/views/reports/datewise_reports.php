						...
						<div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Marker Date Wise Reports</h4>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                                    <form class='form-inline' action='' method='GET'>
                                        <div class='form-group'>
                                            ...
                                            <input type="text" class="form-control" name="date" id='basic-datepicker' placeholder="Select Date" value="<?php echo $date; ?>" onchange="setSens();" readonly="true"/>
											</div>&nbsp;&nbsp;&nbsp;
											 <!-- <div class='form-group'>
								...
								<table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($reports as $report) {
                                            $query = $this->SubjectsModel->get_subjects_in($report['subject_code']);
                                            ...
                                            echo "<tr>
													...
													<td>".$report['subject_code']."-".$subject_name."</td>
...
function onCklickBtn(){
	...
	window.location=baseurl+"marker/datewise?date="+minDate; //course field added by vikas on 17/04/23
