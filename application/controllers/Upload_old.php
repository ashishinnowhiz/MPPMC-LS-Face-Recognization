...
//code end here   
    ...
    public function json_sheets($allocation_id=1)
    {
        ...
        if ($settings['ftp']['success']==1) {
            $obj=json_decode($settings['ftp']['data']);
    ...
    public function download_ftp($file, $allocation_id){
        ...
        if (isset($_SESSION['settings'])) {
            ...
            if ($this->ftp->connect($_SESSION['settings'])) {
                ...
                if ($this->ftp->download('/synced/'.$file, $tempfile)) { // Code With Ubes (Replace Ftp.php from MPSOS DEC 24 Latest Code)
