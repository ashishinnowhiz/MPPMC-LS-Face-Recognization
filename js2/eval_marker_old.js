        ...
        if (sheet.notAttempted) {
            for (i = 0; i < schemeObj.length; i++) {
                if (jQuery.inArray(i, sheet.notAttempted) >= 0) {
                    ...
                    cell2.innerHTML = "<span id='sumMark" + i + "'>-</span>/";
                    schemeObj[i]['oldMarks'] = 'NA';
                }
            ...
            for (i = 0; i < schemeObj.length; i++) {
                ...
                if (schemeObj[i].Question_No == 'parent') {
                    ...
                    cell1.innerHTML = schemeObj[i].Question_No;
                    cell2.innerHTML = "<span id='sumMark" + i + "'>0</span>";
                }
                allotedMarksSum[i] = 'NA';
                if (schemeObj[i].Group != '') {
                    var gname = schemeObj[i].Group;
            ...
            cell1.innerHTML = "<b>Total</b>";
            cell2.innerHTML = "<b><span id='totalMark'>0</span></b>";
        }
        ...
        if (sheet.notAttempted) {
            for (i = 0; i < schemeObj.length; i++) {
                if (jQuery.inArray(i, sheet.notAttempted) >= 0) {
                    ...
                    var cell2 = row.insertCell(1);
                    cell1.innerHTML = schemeObj[i].Question_No;
                    cell2.innerHTML = "<span id='sumMarkh" + i + "'>-</span>/";
                    schemeObj[i]['oldMarks'] = 'NA';
                }
            ...
            for (i = 0; i < schemeObj.length; i++) {
                ...
                if (schemeObj[i].Question_No == 'parent') {
                    ...
                    cell1.innerHTML = schemeObj[i].Question_No;
                    cell2.innerHTML = "<span id='sumMarkh" + i + "'>0</span>";
                }
                allotedMarksSumH[i] = 'NA';
                if (schemeObj[i].Group != '') {
                    var gname = schemeObj[i].Group;
            ...
            cell1.innerHTML = "<b>Total</b>";
            cell2.innerHTML = "<b><span id='totalMarkh'>0</span></b>";
        }
...
function loadPaper(queDetails) {
    ...
    for (i = 1; i <= totalPages['que']; i++) {
        $('#quePageDiv' + i).show();
        $('#quePageDiv' + i + ' img').attr('src', base_url + 'sheet/page/' + (i - 1) + '?url=' + sheet.paper_model_question);
