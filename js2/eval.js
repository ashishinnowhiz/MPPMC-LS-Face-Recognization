        ...
        var y=drag.top-offset.top;
            ...
            if(commentText.length>0){
				...
				var obj1={
					...
					eval_date_time:currentDateTime(),
				};
...
function rejectSheet(){
    ...
    }else if(reason=='Other' || reason=='Different Language' || reason=='Different Set' || reason=='Different Subject' || reason=='Page Are Blur' || reason=='Show Submit Button'){ // Code With Ubes
...
function reasonChange(reason){
    ...
    //     $('#rejectOther').hide();
    // }
    $('#rejectOther').show(); // Code With Ubes
}
